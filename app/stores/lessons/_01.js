var _01 = {
	...
	Homework: [
		{
			...
			urlText: "Dash",
			description: "If you didn't get a chance to finish the pre-work, now is your chance! Dash teaches HTML, CSS, and Javascript through fun projects you can do in your browser. Each task should be pretty straight forward - telling you directly what to code."
		},
		{
	...
	Links: [
		{
			url: "https://github.com/ga-students/FEWD-SEA-6",
			urlText: "Student Repository",
			description: "This is the Student Repository for the class. Make sure to have a clone of this repository on your computer. On occasion new material will be added (i.e. starter code, resources, etc.) throughout the class, and you'll need to sync/pull the updates from the repository to your local repository."
		}
	]
};
