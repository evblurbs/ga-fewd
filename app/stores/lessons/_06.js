var _06 = {
  ...
  description: "In this lesson, we are going to dive into JavaScript. We will go over what it is, and what it is used for. We will go over syntax, variables, functions, objects. At the end of the lesson, you will be introduced to jQuery.",
  slides: "/06-javascript-intro.md",
  number: "06",
  date: '8.20.15',
  Homework: [
    {
